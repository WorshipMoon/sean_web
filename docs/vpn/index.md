...
##### 苹果手机
使用外区账号下载 Hiddify(“Hiddify Proxy & VPN”（免费）),或者小火箭（收费），外区账号注册参照 [AppleID美区注册教程](/KnowledgeBase/AppleID美区注册.md)，外区账号如需购买白板号可以联系
##### win7安装
...
2. 选择节点
代理页面可以选择一个节点，默认是自动选择的。先点击"2"处按钮设置延迟排序，方便以后选择，然后点击"1"处按钮测速
